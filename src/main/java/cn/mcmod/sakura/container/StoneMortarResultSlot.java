...
public class StoneMortarResultSlot extends SlotItemHandler {
    public final StoneMortarBlockEntity tileEntity;
    private final Player player;
    private int removeCount;

    public StoneMortarResultSlot(Player player, StoneMortarBlockEntity tile, IItemHandler inventoryIn, int index,
