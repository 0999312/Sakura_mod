...
public class BlockVanillaSplint extends Block {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(ItemStack.areItemsEqual(heldSeed, new ItemStack(ItemLoader.MATERIAL, 1, 20))){
			worldIn.setBlockState(pos, BlockLoader.VANILLACROP.getDefaultState().withProperty(BlockVanillaCrop.AGE, 0));
