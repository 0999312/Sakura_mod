...
public class WorldGenBigSakura extends WorldGenAbstractTree
{
    ...
    List<WorldGenBigSakura.FoliageCoordinates> foliageCoords;

    public WorldGenBigSakura(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenBigSakura.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenBigSakura.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenBigSakura.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), BlockLoader.SAKURA_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
    ...
    void generateTrunk()
    {
        ...
        Block block = BlockLoader.SAKURA_LOG;
