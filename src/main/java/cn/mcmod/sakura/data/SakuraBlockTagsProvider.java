...
public class SakuraBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        this.tag(BlockTags.LOGS).add(BlockRegistry.STRIPPED_SAKURA_WOOD.get(), BlockRegistry.STRIPPED_MAPLE_WOOD.get(),
                BlockRegistry.SAKURA_WOOD.get(), BlockRegistry.MAPLE_WOOD.get(),BlockRegistry.STRIPPED_SAKURA_LOG.get(), 
        ...
        this.tag(BlockTags.LOGS_THAT_BURN).add(BlockRegistry.STRIPPED_SAKURA_WOOD.get(), BlockRegistry.STRIPPED_MAPLE_WOOD.get(),
                BlockRegistry.SAKURA_WOOD.get(), BlockRegistry.MAPLE_WOOD.get(),BlockRegistry.STRIPPED_SAKURA_LOG.get(), 
                BlockRegistry.STRIPPED_MAPLE_LOG.get(),BlockRegistry.SAKURA_LOG.get(), BlockRegistry.MAPLE_LOG.get(), 
                BlockRegistry.MAPLE_SAP_LOG.get());
        ...
        this.tag(BlockTags.CROPS).add(BlockRegistry.RICE_CROP.get(), BlockRegistry.BUCKWHEAT_CROP.get(),
                BlockRegistry.CABBAGE_CROP.get(), BlockRegistry.EGGPLANT_CROP.get(),
                BlockRegistry.ONION_CROP.get(), BlockRegistry.RADISH_CROP.get(),
                BlockRegistry.RAPESEED_CROP.get(), BlockRegistry.REDBEAN_CROP.get(),
                BlockRegistry.RICE_CROP_ROOT.get(), BlockRegistry.TARO_CROP.get(),
                BlockRegistry.TOMATO_CROP.get());
        
        this.tag(BlockTags.PLANKS).add(BlockRegistry.SAKURA_PLANK.get(), BlockRegistry.BAMBOO_PLANK.get(), BlockRegistry.MAPLE_PLANK.get());
    }
