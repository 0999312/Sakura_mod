...
public class DistillerRecipeBuilder {
    ...
    public DistillerRecipeBuilder requires(TagKey<Item> tag) {
        return this.requires(Ingredient.of(tag));
    }

    public DistillerRecipeBuilder requires(ItemLike item) {
        return this.requires(item, 1);
    }

    public DistillerRecipeBuilder requires(ItemLike item, int count) {
    ...
    public DistillerRecipeBuilder requires(Ingredient ingre) {
        return this.requires(ingre, 1);
    }

    public DistillerRecipeBuilder requires(Ingredient ingre, int count) {
        for (int i = 0; i < count; ++i) {
    ...
    public DistillerRecipeBuilder addResult(ItemLike result, int count) {
