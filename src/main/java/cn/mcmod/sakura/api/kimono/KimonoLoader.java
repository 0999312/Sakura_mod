...
public class KimonoLoader {
	private static final KimonoLoader instance = new KimonoLoader();
	private KimonoLoader() {
	}
	public static KimonoLoader getInstance() {
		return instance;
	}
	...
	public Map<ResourceLocation, ItemStack> KimonoRegistry = Maps.newHashMap();
	...
	public ItemStack getCustomKimono(String modid, String name) {
		return findItemStack(modid, name, 1);
	}

	public ItemStack getCustomKimono(String key) {
		String modid;
		String name;
		{
